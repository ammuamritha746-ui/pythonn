...
employee = Employee("Ravi", "Staff")
trainer = Trainer("Arun", "Trainer", "Weight Training")
yoga = YogaInstructor("Anjali", "Yoga Instructor", "Hatha Yoga")
multi = MultiTrainer("Amritha", "Multi Trainer", "Fitness Training", "Vinyasa Yoga")
